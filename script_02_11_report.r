...
file1<-paste0(dataroot,"subregion_medium_test4.sqlite")          #for planting activity 
# file1<-paste0(dataroot,"subregion_medium_test4noplant.sqlite") # without planting
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"planting_regcut60percent_clearolderthat80"
