...
file1<-paste0(dataroot,"subregion_medium_test4_02.sqlite")            # with planting activity and useSustainableHarvest 0.2
# file1<-paste0(dataroot,"subregion_medium_test4_05.sqlite")          # with planting activity and useSustainableHarvest 0.5
# file1<-paste0(dataroot,"subregion_medium_test4_08.sqlite")          # with planting activity and useSustainableHarvest 0.8
